...
<div id="default-col-interna">
    <div class='content-dashboard'>
      <div class="wrapper wrapper-content">
        ...
        <form name="formulario" action="<?php echo site_url("dados/atualizachecklist")?>" method="POST">
      ...
      ";
            ...
            <input type="hidden" name="checklist" value="<? echo $codigo ?>">
            <input type="hidden" name="maquina" value="<? echo $maquina ?>">

            <center class="eng-buttons-modal">

         <input type="submit"  id="botao"  class="default-blue-btn" value="Salvar"> 
         &nbsp;&nbsp;&nbsp;&nbsp;
         <a href="<?php echo site_url("dados/deletachecklist?codigo=$codigo")?>">
