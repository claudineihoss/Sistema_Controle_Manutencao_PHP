...
<body>
  ...
  if (empty($_POST['maquina'])) {
    $parametro="SELECT maquina,componente,data,obs  FROM preventiva";
    ...
    $parametro="SELECT maquina,componente,data,obs  FROM preventiva where maquina=$maquina and cast( data as date )BETWEEN '$datainicio' and '$datafim'";
  }
          ...
          <div class="new-col col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-title">
                <h4>
                  <center>Relatório Manutenção Preventiva
                </h4>
              </div>
            </div>
          </div>
        </div>
        <form name="dados" action="<?php echo site_url("dados/imprimepreventiva") ?>" method="POST">
        <div class="col-md-4">
